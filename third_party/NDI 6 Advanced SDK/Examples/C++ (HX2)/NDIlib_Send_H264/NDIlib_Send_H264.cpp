...
int main(int argc, char* argv[])
{
	...
	NDI_send_description.p_ndi_name = "H264 HX Test";
	...
	init_video_data(highQ_data, 2, video_highQ_info, NDIlib_FourCC_video_type_ex_H264_highest_bandwidth);
	init_video_data(lowQ_data, 2, video_lowQ_info, NDIlib_FourCC_video_type_ex_H264_lowest_bandwidth);
