...
#ifdef _WIN64
	HMODULE hLib = LoadLibraryW(L"Processing.NDI.Lib.Advanced.x64.dll");
#else // _WIN64
	HMODULE hLib = LoadLibraryW(L"Processing.NDI.Lib.Advanced.x86.dll");
#endif // _WIN64
	if (!hLib)
		return;
...
bool win32_to_ndi::error(void) const
{
...
void win32_to_ndi::end(void)
{
	...
	const bool changes = bgrx_to_uyvy_cond(
		/* src */m_p_data[0], m_xres * 4,
