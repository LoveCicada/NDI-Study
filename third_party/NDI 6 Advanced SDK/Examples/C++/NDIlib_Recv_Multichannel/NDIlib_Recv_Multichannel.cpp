...
{
	char ndi_recv_name[128];
	snprintf(ndi_recv_name, sizeof(ndi_recv_name), "Example Multichannel Receiver %d", channel_no);
	...
	recv_create_desc.p_ndi_recv_name = ndi_recv_name;
